...
def plot_vtx_z():
    ...
    #MC input
    #mc_inp = TFile.Open("../../ana/starsim/slight14b1/sel3/ana_slight14b1_sel3_nzvtx.root")
    #mc_inp = TFile.Open("../../ana/starsim/slight14b2/sel3/ana_slight14b2_sel3_nzvtx.root")
    #mctree = mc_inp.Get("jRecTree")
    ...
    cut_lo = ut.cut_line(-40, 0.8, hVtx)
    ...
    ut.add_leg_mass(leg, mmin, mmax)
    leg.AddEntry(hVtx, "Data")
    leg.AddEntry(hVtxMC, "MC", "l")
    leg.AddEntry(cut_lo, "Cut at #pm40 cm", "l")
